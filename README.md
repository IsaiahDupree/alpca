...
The denominator is the point: **64 documented case studies → 2 deployed sleeves.** Four graphics
...
`docs/EDGE_CASE_STUDIES.md` (all 64 cases) · `docs/Alpca_Discovery_and_HFT_Assessment.docx`.
