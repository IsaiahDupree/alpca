...
The denominator is the point: **58 documented case studies → 2 deployed sleeves.** Four graphics
...
`docs/EDGE_CASE_STUDIES.md` (all 58 cases) · `docs/Alpca_Discovery_and_HFT_Assessment.docx`.
