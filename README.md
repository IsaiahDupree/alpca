...
The denominator is the point: **63 documented case studies → 2 deployed sleeves.** Four graphics
...
`docs/EDGE_CASE_STUDIES.md` (all 63 cases) · `docs/Alpca_Discovery_and_HFT_Assessment.docx`.
