...
BUCKETS = {
    "Deployed (survived every control)": {
        "color": GREEN,
        "cases": [1, 46, 49, 50],   # pairs (1, PIT re-test 46) + short-vol (49, tail-stress 50)
        "note": "2 distinct sleeves: cointegrated-pairs basket + short-vol/VRP",
    },
    ...
    "Too weak / dilutes / inert": {
        "color": AMBER,
        "cases": [3, 9, 12, 15, 24, 37, 39, 40, 47, 48, 57],
        "note": "real but sub-rail; adds no lift to the book",
    },
